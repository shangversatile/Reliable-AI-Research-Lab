...
| graph convolution foundations | What operation is being applied over graph structure? | Required before implementation | Derive or explain graph convolution mechanism | Explain spectral filtering, polynomial K-hop localization, and Chebyshev recurrence; map them to the planned STGCN graph convolution interface. | Reading |
